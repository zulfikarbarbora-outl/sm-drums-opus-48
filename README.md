...
Opus 48 kbps preview MP3s for the **SMDrums** sample library.
...
- **Files**: 3616 Opus previews
- **Bitrate**: 48 kbps VBR
- **Container**: Ogg Opus (.opus)
- **Source**: [`zulfikarbarbora-outl/SMDrums`](https://github.com/zulfikarbarbora-outl/SMDrums)
- **Branch**: `main`

## URL pattern

```
https://raw.githubusercontent.com/zulfikarbarbora-outl/sm-drums-opus-48/main/<filename>.opus
```
